...
export default function LeaveHub() {
  ...
  const fetchLeaves = async () => {
    ...
    try {
      ...
      if (result.success) {
        setAllLeaves((result.leaves || []).map((l, i) => ({ ...l, _rowIndex: i + 2 })));
      }
  ...
  return (
    <div className="h-screen overflow-y-auto bg-[#F0F9FF] font-black text-slate-950">
      <div className="p-4 md:p-10 pb-36 max-w-[1000px] mx-auto space-y-8">
