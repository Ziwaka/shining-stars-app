...
export default function LuxurySingleScreenPage() {
  ...
  return (
    /* ✅ Fixed inset-0 and top-0 ensure the layout starts exactly at the top, killing the black bar */
    <div className="fixed inset-0 h-screen w-full flex flex-col items-center justify-between bg-[#4c1d95] text-white selection:bg-[#FFD700] m-0 p-0 overflow-hidden">
      
      {/* Background Atmosphere Overlays */}
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1541339907198-e08756dedf3f?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center mix-blend-overlay opacity-15"></div>
      <div className="absolute inset-0 bg-gradient-to-b from-[#4c1d95] via-[#3b0764] to-[#020617]"></div>
      ...
      <div className="relative z-10 w-full flex flex-col items-center pt-16 px-6 text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          {/* ✅ FIXED: Correct Name on one line with hyphen */}
      ...
      <div className="relative z-10 w-full max-w-sm px-8 space-y-6 pb-16 pt-6">
        ...
        >
          {/* ✅ Slate-950 and Bold for absolute clarity */}
        ...
        {/* 2. Public Zone Card (Gold/Slate-950) */}
        <button 
      ...
      <div className="relative z-10 w-full text-center pb-10 px-6">
         <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/40 leading-relaxed">
           ESTABLISHED 2019 | TAUNGGYI<br/>SHAN STATE, MYANMAR
         </p>
      </div>
    </div>
  );
