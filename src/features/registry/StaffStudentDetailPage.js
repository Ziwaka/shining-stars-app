...
// ── MMT Date Converter (Date object / ISO string များကို MMT string သို့ ပြောင်း) ──
function toMMTDateStr(val) {
  ...
  // yyyy-MM-dd ရက်စွဲသက်သက် (သို့) စာသား → မပြောင်းဘဲ ပြန်
  return str;
}
          ...
          {activeTab === "PROFILE" ? (
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-4">
                {/* Leave History Section (ALL RECORDS) */}
